...
|---------------------------------- |------- |----------:|-----------:|---------:|-------:|----------:|
| **FilterByCompetingSecondaryIndexes** | **fsdb**   | **355.65 μs** | **134.803 μs** | **7.389 μs** |      **-** |     **747 B** |
| **FilterByCompetingSecondaryIndexes** | **mysql**  |  **45.91 μs** |   **4.202 μs** | **0.230 μs** | **0.0610** |     **747 B** |
