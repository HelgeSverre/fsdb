          ...
          <| fun _ ->
              ...
              for sql, functionName in
                  [ "SELECT DATE_FORMAT('2020-01-01')", "DATE_FORMAT"
                    ...
                    "SELECT SEC_TO_TIME()", "SEC_TO_TIME"
                    "SELECT UUID_TO_BIN()", "UUID_TO_BIN"
                    "SELECT BIN_TO_UUID()", "BIN_TO_UUID"
                    "SELECT IS_UUID()", "IS_UUID"
                    "SELECT INET_ATON()", "INET_ATON"
                    "SELECT INET_NTOA()", "INET_NTOA"
                    "SELECT INET6_ATON()", "INET6_ATON"
                    "SELECT INET6_NTOA()", "INET6_NTOA"
                    "SELECT IS_IPV4()", "IS_IPV4"
                    "SELECT IS_IPV6()", "IS_IPV6"
                    "SELECT IS_IPV4_COMPAT()", "IS_IPV4_COMPAT"
                    "SELECT IS_IPV4_MAPPED()", "IS_IPV4_MAPPED"
                    "SELECT JSON_SEARCH('{}', 'one')", "JSON_SEARCH"
                    "SELECT ORD()", "ORD"
                    "SELECT HEX()", "HEX"
                    "SELECT UNHEX()", "UNHEX"
                    "SELECT MD5()", "MD5"
                    "SELECT SHA1()", "SHA1"
                    "SELECT SHA2('abc')", "SHA2"
                    "SELECT TO_BASE64()", "TO_BASE64"
                    "SELECT FROM_BASE64()", "FROM_BASE64"
                    "SELECT SUBSTRING_INDEX('a,b', ',')", "SUBSTRING_INDEX"
                    "SELECT SPACE()", "SPACE"
                    "SELECT LPAD('a', 3)", "LPAD"
                    "SELECT RPAD('a', 3)", "RPAD"
                    "SELECT LTRIM()", "LTRIM"
                    "SELECT RTRIM()", "RTRIM"
                    "SELECT CONCAT()", "CONCAT"
                    "SELECT CONCAT_WS('-')", "CONCAT_WS"
                    "SELECT JSON_TYPE()", "JSON_TYPE"
                    "SELECT JSON_VALID()", "JSON_VALID"
                    "SELECT JSON_DEPTH()", "JSON_DEPTH"
                    "SELECT JSON_LENGTH()", "JSON_LENGTH"
                    "SELECT JSON_STORAGE_SIZE()", "JSON_STORAGE_SIZE"
                    "SELECT JSON_STORAGE_FREE()", "JSON_STORAGE_FREE"
                    "SELECT JSON_UNQUOTE()", "JSON_UNQUOTE"
                    "SELECT JSON_QUOTE()", "JSON_QUOTE"
                    "SELECT JSON_PRETTY()", "JSON_PRETTY"
                    "SELECT JSON_KEYS()", "JSON_KEYS"
                    "SELECT JSON_CONTAINS('[1,2]')", "JSON_CONTAINS"
                    "SELECT JSON_OVERLAPS('[1,2]')", "JSON_OVERLAPS"
                    "SELECT JSON_SCHEMA_VALID('{}')", "JSON_SCHEMA_VALID"
                    "SELECT JSON_SCHEMA_VALIDATION_REPORT('{}')", "JSON_SCHEMA_VALIDATION_REPORT"
                    "SELECT DAYOFMONTH()", "DAYOFMONTH"
                    "SELECT DAYOFWEEK()", "DAYOFWEEK"
                    "SELECT DAYOFYEAR()", "DAYOFYEAR"
                    "SELECT WEEKDAY()", "WEEKDAY"
                    "SELECT WEEKOFYEAR()", "WEEKOFYEAR"
                    "SELECT YEARWEEK()", "YEARWEEK"
                    "SELECT LAST_DAY()", "LAST_DAY"
                    "SELECT DATEDIFF('2024-03-02')", "DATEDIFF"
                    "SELECT TIMEDIFF('12:00:01')", "TIMEDIFF"
                    "SELECT ADDTIME('10:00:00')", "ADDTIME"
                    "SELECT SUBTIME('10:00:00')", "SUBTIME"
                    "SELECT MAKEDATE(2024)", "MAKEDATE"
                    "SELECT MAKETIME(12, 34)", "MAKETIME"
                    "SELECT TO_DAYS()", "TO_DAYS"
                    "SELECT FROM_DAYS()", "FROM_DAYS"
                    "SELECT UNIX_TIMESTAMP(1, 2)", "UNIX_TIMESTAMP"
                    "SELECT FROM_UNIXTIME()", "FROM_UNIXTIME"
                    "SELECT TIME_FORMAT('12:34:56')", "TIME_FORMAT"
                    "SELECT STR_TO_DATE('2024-02-29')", "STR_TO_DATE"
                    "SELECT CONVERT_TZ('2024-02-29', '+00:00')", "CONVERT_TZ"
                    "SELECT DAYNAME()", "DAYNAME"
                    "SELECT MONTHNAME()", "MONTHNAME"
                    "SELECT PERIOD_ADD(202312)", "PERIOD_ADD"
                    "SELECT PERIOD_DIFF(202402)", "PERIOD_DIFF"
                    "SELECT CEIL()", "CEIL"
                    ...
                    "SELECT RANDOM_BYTES()", "RANDOM_BYTES"
