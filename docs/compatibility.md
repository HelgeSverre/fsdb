...
trigger gaps are cursors, dynamic SQL, and multi-table DML firing. Compound
bodies support CASE and labeled loops, scoped conditions, handlers, and
SIGNAL/RESIGNAL. The full MySQL surface is documented under
