...
| sql_mode | ~20 mode bits with semantic effect | strictness, zero-date modes, ONLY_FULL_GROUP_BY, ANSI_QUOTES, IGNORE_SPACE, and PIPES_AS_CONCAT (including ANSI implication) have effect; most other mode bits remain inert | medium | divergence |
