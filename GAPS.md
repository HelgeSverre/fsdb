...
| JSON second half | `JSON_MERGE_PATCH JSON_MERGE_PRESERVE JSON_SCHEMA_VALID JSON_SCHEMA_VALIDATION_REPORT JSON_VALUE JSON_ARRAY_APPEND JSON_ARRAY_INSERT JSON_STORAGE_SIZE JSON_STORAGE_FREE` | medium |
