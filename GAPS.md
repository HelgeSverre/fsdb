...
| sql_mode | ~20 mode bits with semantic effect | strictness, zero-date modes, ONLY_FULL_GROUP_BY, ANSI_QUOTES, and IGNORE_SPACE have effect; most other mode bits remain inert | medium | divergence |
