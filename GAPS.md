...
| Column definition fidelity | schema/table/org_table names, requested charsetnr | declared columns and explicit COLLATE expressions report their MySQL collation ids; source names remain empty, and untyped text probes retain the protocol fallback 45 | low | partial |
