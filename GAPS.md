...
materialized once per statement, compatible integer/string/decimal scalar and
row-value `IN` materializations with reusable membership sets and direct indexed
