...
| Depth-three syntax stress | Three 10,000-mutation seeds plus 70 baselines produced no crash, timeout, protocol fault, or invariant failure. The 97–117 differences per seed cluster in the six declared feature gaps and executable-comment/error-contract edges. Fuzz-found incomplete procedure blocks and reserved ROW/PARTITION aliases now reject with 1064 | compatibility differences retained; parser fixes verified 2026-08-27 |
