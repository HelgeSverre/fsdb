...
| sql_mode | ~20 mode bits with semantic effect | strictness, zero-date modes, ONLY_FULL_GROUP_BY, ANSI_QUOTES, IGNORE_SPACE, PIPES_AS_CONCAT (including ANSI implication), HIGH_NOT_PRECEDENCE, NO_AUTO_VALUE_ON_ZERO, and NO_UNSIGNED_SUBTRACTION have effect; most other mode bits remain inert | medium | divergence |
