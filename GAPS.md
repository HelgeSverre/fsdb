...
| Crash/restart durability | concurrent two-table transactions were interrupted by 40 forced process crashes across two 16-worker campaigns. Recovery retained every acknowledged commit, exposed no partial transaction, invented no row, and preserved identical state through graceful snapshot restarts; the runs recovered 2,298 and 2,064 complete operations | resolved 2026-08-25; broader snapshot-rotation volume remains useful stress coverage |
