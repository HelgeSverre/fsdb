...
| sql_mode | ~20 mode bits with semantic effect | strictness, zero-date modes, ONLY_FULL_GROUP_BY, ANSI_QUOTES, IGNORE_SPACE, PIPES_AS_CONCAT (including ANSI implication), and HIGH_NOT_PRECEDENCE have effect; most other mode bits remain inert | medium | divergence |
