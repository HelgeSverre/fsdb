...
| `EXPLAIN FORMAT=JSON` reports the logical access plan without MySQL's cost model; `EXPLAIN ANALYZE` and `FORMAT=TREE` remain absent | low | divergence/refusal |
